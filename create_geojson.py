#######################################################################################
## Title:   create_geojson.py
## Author:  Maria Cupples Hudson
## Purpose: Create json files for distince points in time using historical shape
##          files downloaded from the Atlas of Historical County Boudaries.
